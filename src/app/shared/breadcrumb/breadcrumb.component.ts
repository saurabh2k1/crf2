...
import { Router, ActivatedRoute, NavigationEnd, Event, ActivationEnd } from '@angular/router';
import { filter, pluck, buffer, map, distinctUntilChanged } from 'rxjs/operators';
